...
def runChallenge(challenge_code: str, token) -> str:
    ...
    open("./justAnotherKahootBot/challenge/challenge.js", "w").write(challenge_script)
   

    result = subprocess.run(['node', "./justAnotherKahootBot/challenge/challenge.js"], capture_output=True, text=True)
