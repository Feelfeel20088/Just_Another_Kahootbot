...
def test_run_challenge():
    js_challenge_str = "decode.call(this, 'CHH7d8RTfdxAxhQMN2Qxlg81ELRIj2YTer6aeQLSslnI6djb42bmEj9K1I8NMLEcWELPCu9NF7EB3Q3vWtXreXM7FeWfOaT6dVUt'); function decode(message) {var offset = 87*99+((86*(10*12))*99+59); if(this.angular.isDate(offset)) console.log('Offset derived as:', offset); return _.replace(message,/./g,function(char,position){return String.fromCharCode((((char.charCodeAt(0)*position)+offset)%77)+48);});}"
